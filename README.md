...
```bash
git clone https://github.com/Dionatas1114/whaticket_v2
```
...
<p>
  Any help and suggestions will be apreciated :+1:

  Se puder fazer uma doação para este DEV, utilize o PIX: :gift::shipit:
  
  <img src="https://github.com/Dionatas1114/whaticket_v2/blob/master/images/qrcode.png" width="400" height="400"/>
</p>
